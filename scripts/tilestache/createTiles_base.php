<?php
  ...
  for($i=1;$i<=168;$i++) {
      ...
      fwrite($file, $config);
      fclose($file);
      $seed = "/home/grantdmckenzie/Downloads/TileStache-1.49.8/scripts/tilestache-seed.py -c /var/www/tilestache//var/www/tilestache/configFiles/".$filename.".cfg -l ".$filename." -d /var/www/tilestache/ -b 33.5678749084473 -118.84309387207 34.3265800476074 -117.49584197998 -e png 10";
      // echo $seed . "\n";
      exec($seed);
  }
?>